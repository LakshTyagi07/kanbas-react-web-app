...
import * as client from "./client";  // Import the client directly
...
const AssignmentEditor = () => {
  ...
  useEffect(() => {
    if (aid !== "new") {
      client.getAssignment(aid!).then((assignment) => {
  ...
  const addOrEditAssignment = async () => {
    try {
      if (aid === "new") {
        ...
        await client.updateAssignment(aid!, updatedAssignment);
      }
    ...
    <div id="wd-assignments-editor" className="form-group">
      <div className="w-100">
        ...
        <input
          ...
          placeholder={aid === "new" ? "New Assignment" : title}
          value = {title}
        ...
        <textarea
          ...
          placeholder={aid === "new" ? "Add a description for this assignment..." : description}
          value = {description}
            ...
            <div className="d-flex gap-3 mt-3 w-100">
              <div className="d-flex flex-column w-100">
                ...
                <input
                  ...
                  className="form-control"
                  placeholder={aid === "new" ? "" : availableFrom}
                  value = {availableFrom}
